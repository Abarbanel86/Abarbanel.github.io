...
let BodyComponent = class BodyComponent {
    constructor(data, weatherData, searchService) {
        this.data = data;
...
let SearchBarComponent = class SearchBarComponent {
    constructor(data, weather, weatherData, searchService) {
        this.data = data;
...
let DataService = class DataService {
    ...
    getfiveDaysSearchWasMade() {
        return this.fiveDaysSearchWasMade.value;
    }
    setFiveDaysSearchWasMade(val) {
...
let SearchService = class SearchService {
    constructor(weatherService, weatherDataService, weatherData) {
    ...
    handleFiveDays(response) {
        this.fiveDayDates = [];
        this.fiveDaysMin = [];
        this.fiveDayMax = [];
        for (let i = 0; i < _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].numberOfDays; ++i) {
...
let WeatherService = class WeatherService {
    ...
    getAutoComplete(phrase) {
        let url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].autoCompleteURL + _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiKey +
            "&q=" + phrase + _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].language;
        return this.http.get(url);
    }
    getFiveDays(locationKey) {
        let metric = this.data.getTempFormat();
        let url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].fiveDaysURL + locationKey + _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiKey
    ...
    getGeoLocation(lat, lng) {
        let url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].geoLocationURL + _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiKey + '&q=' + lat.toString()
...
const environment = {
    ...
    locationKeyURL: "http://dataservice.accuweather.com/locations/v1/",
    fiveDaysURL: "http://dataservice.accuweather.com/forecasts/v1/daily/5day/",
    geoPostionSearchURl: "http://dataservice.accuweather.com/locations/v1/cities/geoposition/search",
